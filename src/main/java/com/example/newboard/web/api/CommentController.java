...
public class CommentController {
    ...
    // 댓글 등록
    @PostMapping
    public ResponseEntity<CommentResponse> addComment(@PathVariable Long articleId, @RequestBody CommentRequest request, Authentication authentication) {
        Comment savedComment = commentService.addComment(articleId, request.getContent(), authentication);
